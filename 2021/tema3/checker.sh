...
echo "Version 1.7 - Valgrind Only - RC Online"
...
cp tasks/image_editor/tests/05-image_editor/05-image_editor.in bk/02-image_editor/02-image_editor.in
cp tasks/image_editor/tests/05-image_editor/05-image_editor.ref bk/02-image_editor/02-image_editor.ref

cp tasks/image_editor/tests/55-image_editor/55-image_editor.in bk/03-image_editor/03-image_editor.in
cp tasks/image_editor/tests/55-image_editor/55-image_editor.ref bk/03-image_editor/03-image_editor.ref
